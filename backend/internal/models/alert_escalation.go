...
// AlertEscalation manages 911 / external emergency services escalating from standard SOS calls.
type AlertEscalation struct {
	...
	ExternalReferenceID string     `gorm:"type:varchar(255)" json:"external_reference_id"` // E.g., Twilio 911 Call SID
